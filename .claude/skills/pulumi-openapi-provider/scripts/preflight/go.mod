...
// Points at the pulumi-openapi-provider checkout. When this directory is copied
// elsewhere, repoint it:
//
//	go mod edit -replace github.com/pierskarsenbarg/pulumi-openapi-provider=/path/to/repo
